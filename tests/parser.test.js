...
describe('sbf-parser Node', function () {
  ...
  it('should be loaded', function(done){
    const flow = [
      { id: "n1", type: "sbf-parser", name: "Septentrio" }
    ]; 
  ...
  it('should inject data & parse', (done) => {
    const flow = [
      { id: "n1", type: "sbf-parser", name: "Septentrio", wires:[["n2"]] },
      { id: "n2", type: "helper" }
    ];
    ...
    helper.load(SBFParser, flow, function() {
      ...
      // Add data
      const data = Buffer.from([36, 64, 221, 226, 167, 79, 96, 0, 112, 136, 215, 27, 219, 8, 1, 0, 25, 100, 17, 79, 149, 146, 230, 63, 244, 255, 188, 118, 114, 163, 176, 191, 198, 152, 182, 50, 84, 16, 133, 64, 236, 186, 78, 66, 229, 135, 156, 187, 164, 172, 80, 56, 99, 167, 142, 187, 249, 2, 149, 208, 184, 78, 200, 18, 157, 251, 197, 191, 7, 245, 17, 190, 0, 19, 6, 0, 246, 3, 100, 0, 9, 9, 0, 0, 1, 1, 0, 0, 75, 0, 44, 3, 174, 7, 96, 0])
